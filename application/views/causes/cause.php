...
Helper::beginHtml($data->name.' | Causes | Browse | Mobile Charity Navigator');

Helper::beginPage( array('id'=>$data->slug, 'data-title'=>$data->name, 'data-add-back-btn'=>'false', 'data-back-btn-text'=>'Causes', 'data-cn-back-btn'=>'/causes') );
